...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_all(
        KC_ESC,  DE_CIRC,   DE_1,    DE_2,    DE_3,    DE_4,    DE_5,                           DE_6,  DE_7,    DE_8,    DE_9,    DE_0,    DE_SS,    KC_BSPC,
        KC_F1 ,  KC_TAB,    DE_Q,    DE_W,    DE_E,    DE_R,    DE_T,                           DE_Z,  DE_U,    DE_I,    DE_O,    DE_P,    DE_UDIA,  DE_PLUS,
        KC_F2 ,  KC_LSFT,   DE_A,    DE_S,    DE_D,    DE_F,    DE_G,                           DE_H,  DE_J,    DE_K,    DE_L,    DE_ODIA, DE_ADIA,  DE_HASH,
        KC_F3 ,  KC_LCTL,   DE_LABK, DE_Y,    DE_X,    DE_C,    DE_V,                           DE_B,  DE_N,    DE_M,    DE_COMM, DE_DOT,  DE_MINS,  KC_ENT,
                                    KC_LGUI, MO(_LOWER),  KC_SPC,  KC_LALT,                     KC_MPLY, KC_SPC,  MO(_RAISE), KC_RALT ,
                                                                      RGB_RMOD,         RGB_MOD,
                                                     KC_UP,                                              KC_UP,
    ...
    */
    ...
    [_LOWER] = LAYOUT_all(
        _______,  KC_F1,   KC_F1,   KC_F2,   KC_F3,     KC_F4,   KC_F5,                             KC_F6, KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,
    ...
    [_RAISE] = LAYOUT_all(
        ...
        _______,_______, _______,    KC_UP, _______,   _______, _______,                             _______, _______, _______, _______, _______, _______, _______,
        _______,_______, KC_LEFT,  KC_DOWN,KC_RIGHT,   KC_UNDS, KC_NO,                               KC_NO,   KC_EQL,  _______, _______, _______, _______, _______,
